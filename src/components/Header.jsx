...
const Header = () =>  (
    <section id="header" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
          <img src={discount} alt="percentage icon" className="w-[32px] h-[32px]"/>
        ...
        We examine annual percentage rates and annual fees.</p>
      </div>
      // Gradient Background
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        <img src={robot} alt="robot with projection coming out of its hand" className="w-[100%] h-[auto] relative z-[5]" />
